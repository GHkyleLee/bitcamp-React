...
class TwoApp extends Component
{
    ...
    render(){
        return(
            ...
            <button type="button" style={{marginLeft:"70px"}} onClick={this.numberIncre}>증가</button>
            <button type="button"style={{marginLeft:"20px"}} onClick={this.numberDecre}>감소</button>
            </div>
        )
    }
